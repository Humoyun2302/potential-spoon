  ...
  return (
    ...
    >
      <Card className="overflow-hidden border-0 transition-all duration-200 bg-white dark:bg-gray-800 h-full rounded-3xl shadow-sm hover:shadow-md">
        ...
        <div className="bg-gradient-to-b from-[#5B8CFF]/15 to-white dark:from-[#5B8CFF]/20 dark:to-gray-800 px-6 py-8 text-center">
          <h3 className="text-2xl font-bold dark:text-white mb-2 text-[#1b2944]">
            {viewAs === 'customer' 
              ? (booking.barber?.full_name || booking.barberName || 'Barber') 
        ...
        <CardContent className="p-6">
          ...
          <div className="flex flex-col md:flex-row md:items-stretch md:justify-between gap-6 mb-6">
            
            {/* Left Block - Info Stack (Date, Time, Price) */}
            <div className="flex-1 space-y-3">
              <div className="flex items-center gap-3">
                <Calendar className="w-5 h-5 text-[#5B8CFF] flex-shrink-0" />
              ...
              <div className="flex items-center gap-3">
                <Clock className="w-5 h-5 text-[#5B8CFF] flex-shrink-0" />
                <span className="text-base text-gray-900 dark:text-gray-100">
              ...
              <div className="flex items-center gap-3">
                <DollarSign className="w-5 h-5 text-[#5B8CFF] flex-shrink-0" />
              ...
              {viewAs === 'customer' && barberPhone ? (
                <div className="flex items-center gap-2">
                  ...
                  <a
                    ...
                    className="font-semibold text-[#5B8CFF] hover:text-[#155DFC] transition-colors text-base"
                  >
                    {barberPhone}
                  </a>
                </div>
